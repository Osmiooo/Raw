package com.osmiooo.raw.registry;

import com.osmiooo.raw.Raw;
...
public class ModItems {
    ...
    public static final Item RAW_NETHERITE_SCRAP = new Item(new Item.Settings().group(ItemGroup.MISC));
    ...
    public static void registerItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier(Raw.MOD_ID,  "raw_netherite_scrap"), RAW_NETHERITE_SCRAP);
    }
}
